...
public class StudyroomDto {
	...
	public StudyroomDto(Integer prental_id, Date prental_de, String prtime_schedule, String user_id, String croom_id,
			String croom_location, int croom_mpop, String croom_name, String locker_id, String locker_location,
			Date locker_start_date, int locker_cost, Date locker_end_date, Integer serial_id, Integer sroom_seat_id,
			Date sroom_rental_stime, Date sroom_rental_etime) {
		super();
	...
	public int hashCode() {
		return Objects.hash(croom_id, croom_location, croom_mpop, croom_name, locker_cost, locker_end_date, locker_id,
				locker_location, locker_start_date, prental_de, prental_id, prtime_schedule, serial_id,
				sroom_rental_etime, sroom_rental_stime, sroom_seat_id, user_id);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(croom_id, other.croom_id) && Objects.equals(croom_location, other.croom_location)
				...
				&& Objects.equals(prtime_schedule, other.prtime_schedule) && Objects.equals(serial_id, other.serial_id)
	...
	public String toString() {
		return "RentalDto [prental_id=" + prental_id + ", prental_de=" + prental_de + ", prtime_schedule="
				...
				+ ", locker_cost=" + locker_cost + ", locker_end_date=" + locker_end_date + ", serial_id=" + serial_id
				+ ", sroom_seat_id=" + sroom_seat_id + ", sroom_rental_stime="
				+ sroom_rental_stime + ", sroom_rental_etime=" + sroom_rental_etime + "]";
	}
}
